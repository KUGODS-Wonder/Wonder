...
class WalkTrackController extends GetxController with LocationTrackerMixin {
  ...
  void _onWalkCompleted() async {
    ...
    _informServerTask = CancelableOperation.fromFuture(_sendServerWalkCompleted());
  ...
  Future _sendServerWalkCompleted() async {
    ...
    while(!serverReceivedMessage) {
      ...
      serverReceivedMessage = await _walkProvider.informServerWalkCompleted(targetWalk.id, elapsedTime.inSeconds).catchError((error) async {
